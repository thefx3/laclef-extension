  ...
  async function runAutomation() {
    ...
    try {
      ...
      if (mode === "fill") {
        ...
        if (programmation.date_begin || programmation.dateBegin) {
          setInput("#activity_schedule_date_begin", programmation.date_begin || programmation.dateBegin);
        }
        if (programmation.date_end || programmation.dateEnd) {
          setInput("#activity_schedule_date_end", programmation.date_end || programmation.dateEnd);
        }
  ...
  function createAutoModal() {
      ...
      <div class="fx-laclef-modal fx-auto-modal" role="dialog" aria-modal="true">
        ...
        <div class="fx-laclef-modal-body">
          ...
          <section class="fx-music-tab-panel" data-panel="manual" hidden>
            ...
            <div class="fx-laclef-note">Champs attendus : label, debut, fin, duree, jour, salle, prof, places, tarif. Optionnel : date_begin, date_end. Verification ANIAPPS obligatoire avant creation.</div>
            <div class="fx-laclef-modal-actions">
          ...
          <section class="fx-music-tab-panel" data-panel="convert" hidden>
            <div class="fx-laclef-form-grid fx-laclef-form-grid-compact">
              ...
              <div class="fx-laclef-field">
                <label for="fx-auto-convert-date-begin">Debute le</label>
                <input id="fx-auto-convert-date-begin" type="date" value="${escapeHtml(settings.dateBegin || "")}">
              </div>
              <div class="fx-laclef-field">
                <label for="fx-auto-convert-date-end">Termine le</label>
                <input id="fx-auto-convert-date-end" type="date" value="${escapeHtml(settings.dateEnd || "")}">
              </div>
              <div class="fx-laclef-field fx-laclef-field-full">
    ...
    function currentConvertSettings() {
      return {
        ...
        dateBegin: backdrop.querySelector("#fx-auto-convert-date-begin").value,
        dateEnd: backdrop.querySelector("#fx-auto-convert-date-end").value,
